...
function ContactForm() {
  ...
  function sendEmail(e) {
    ...
    //   I have signed up https://www.emailjs.com/ to do that contact form

      emailjs.sendForm('gmail', 'template_1gu1o0z', '#contactForm', 'user_m2PqVYIzeFIgClNP7XKPr')
      .then(function(response) {
        console.log(response.text);
        setFormMessage("Message sent!");
      }, function(error) {
        console.log(error.text);
        setFormMessage("Your message couldn't be sent. Please email Randolph directly at randolphrichard9@gmail.com");
      });
  }
